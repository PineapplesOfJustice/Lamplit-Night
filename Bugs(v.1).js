// Lesson always create a backup file before makiong serious changes. //
...
if(cursorColor == "red"){ var cursor = makeImage("Piskel Art/Cursor1.png", 20, 20, 88, 52, 1); }
else if(cursorColor == "green"){ var cursor = makeImage("Piskel Art/Cursor.png", 20, 20, 88, 52, 1); }
...
function startGame(){
  ...
  insaneButton.remove();
  insaneText.remove();  
  if(cursorColor == "red"){ document.getElementById("canvas").style.cursor = "url('Piskel Art/Cursor1.png') 16 16, crosshair"; } 
  if(cursorColor == "green"){ document.getElementById("canvas").style.cursor = "url('Piskel Art/Cursor.png') 16 16, crosshair"; } 
  cursor.remove();
  setTimeout(function(){ startText1.remove(); }, 400);
  setTimeout(function(){ startText2.remove(); }, 700);
  setTimeout(function(){ makeBug(1, 1); }, 1000);
  if(gameMode != "Insane"){  
    setTimeout(function(){ makeBug(1, 3); }, 1200);
    if(gameMode != "Easy"){ setTimeout(function(){ makeBug(1, 4); }, 1500); }
    setTimeout(function(){ makeBug(1, 2); }, 1900);
  }
...
function shootBullet(event){
  ...
  if(cursorColor == "red"){ bullet.push(makeImage("Piskel Art/Projectile1.png", lampX, lampY, 10, 10, 1)); }
  if(cursorColor == "green"){ bullet.push(makeImage("Piskel Art/Projectile2.png", lampX, lampY, 10, 10, 1)); }
